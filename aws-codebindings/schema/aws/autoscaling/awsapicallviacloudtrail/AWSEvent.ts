...
export class AWSEvent<T> {
    ...
    public static updateAttributeTypeMapDetail(type: string) {
        var index = AWSEvent.attributeTypeMap.indexOf({name: AWSEvent.detail, baseName: AWSEvent.detail, type: AWSEvent.generaicType});
