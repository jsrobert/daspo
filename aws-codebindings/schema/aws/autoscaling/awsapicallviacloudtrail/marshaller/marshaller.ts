...
import { AWSAPICallViaCloudTrail } from '../AWSAPICallViaCloudTrail';
...
let typeMap: {[index: string]: any} = {
    "AWSAPICallViaCloudTrail": AWSAPICallViaCloudTrail,
    "AWSEvent": AWSEvent,
    ...
    "LaunchTemplate_1": LaunchTemplate_1,
    "MixedInstancesPolicy": MixedInstancesPolicy,
    "PredefinedMetricSpecification": PredefinedMetricSpecification,
    "RequestParameters": RequestParameters,
    "RequestParametersItem": RequestParametersItem,
    "RequestParametersItem_1": RequestParametersItem_1,
